...
//definir dos instancias para poder hacer las transiciones entre estados. El primero con framecount entre 0 y 300 y el segundo entre 300 y 600)
public void draw() {
  background(0);
  println("esto " + frameCount);
