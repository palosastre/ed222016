...
//Se crearán dos triángulos en distintas posiciones, unos en color gris y otros en color amarillo, tambien habra un rombo con un punto en el centro
...
void setup () {
size(900, 750);                             //tamaño del canvas
...
for (int y = 20; y < height; y += update){   //si y es menor que el largo del canavs, se le sumará el valor del update
